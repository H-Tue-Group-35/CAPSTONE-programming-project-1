...
?>
    ...
    <div id="wrapper">
        ...
        <div class="loadingio-spinner-spin-8dnfnvk0mg">
            <div class="ldio-0z7qhip88ux">
                <div>
                    <div></div>
                </div>
                <div>
        ...
        .ldio-0z7qhip88ux div>div {
            position: absolute;
            width: 24px;
            height: 24px;
            border-radius: 50%;
            background: #ff727d;
            animation: ldio-0z7qhip88ux 1s linear infinite;
        }

        .ldio-0z7qhip88ux div:nth-child(1)>div {
            left: 148px;
            top: 88px;
            animation-delay: -0.875s;
        }

        .ldio-0z7qhip88ux>div:nth-child(1) {
            transform: rotate(0deg);
            transform-origin: 160px 100px;
        }

        .ldio-0z7qhip88ux div:nth-child(2)>div {
            left: 130px;
            top: 130px;
            animation-delay: -0.75s;
        }

        .ldio-0z7qhip88ux>div:nth-child(2) {
            transform: rotate(45deg);
            transform-origin: 142px 142px;
        }

        .ldio-0z7qhip88ux div:nth-child(3)>div {
            left: 88px;
            top: 148px;
            animation-delay: -0.625s;
        }

        .ldio-0z7qhip88ux>div:nth-child(3) {
            transform: rotate(90deg);
            transform-origin: 100px 160px;
        }

        .ldio-0z7qhip88ux div:nth-child(4)>div {
            left: 46px;
            top: 130px;
            animation-delay: -0.5s;
        }

        .ldio-0z7qhip88ux>div:nth-child(4) {
            transform: rotate(135deg);
            transform-origin: 58px 142px;
        }

        .ldio-0z7qhip88ux div:nth-child(5)>div {
            left: 28px;
            top: 88px;
            animation-delay: -0.375s;
        }

        .ldio-0z7qhip88ux>div:nth-child(5) {
            transform: rotate(180deg);
            transform-origin: 40px 100px;
        }

        .ldio-0z7qhip88ux div:nth-child(6)>div {
            left: 46px;
            top: 46px;
            animation-delay: -0.25s;
        }

        .ldio-0z7qhip88ux>div:nth-child(6) {
            transform: rotate(225deg);
            transform-origin: 58px 58px;
        }

        .ldio-0z7qhip88ux div:nth-child(7)>div {
            left: 88px;
            top: 28px;
            animation-delay: -0.125s;
        }

        .ldio-0z7qhip88ux>div:nth-child(7) {
            transform: rotate(270deg);
            transform-origin: 100px 40px;
        }

        .ldio-0z7qhip88ux div:nth-child(8)>div {
            left: 130px;
            top: 46px;
            animation-delay: 0s;
        }

        .ldio-0z7qhip88ux>div:nth-child(8) {
            transform: rotate(315deg);
            transform-origin: 142px 58px;
        }

        .loadingio-spinner-spin-8dnfnvk0mg {
            width: 200px;
            height: 200px;
